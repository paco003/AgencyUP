App.factory('ListViewStickyHeaderService', ['$timeout', '$rootScope', 'Toast', function($timeout, $rootScope, Toast) {
    return {
        ...
        generateLayout4Items: function(count) {
            ...
            var listImages = [
                    'img/background-small/7.jpg',
                    'img/background-small/10.jpg',
                    'img/background-small/11.jpg',
                    'img/background-small/12.jpg',
                    'img/background-small/13.jpg',
                    'img/background-small/15.jpg',
                    'img/background-small/9.jpg'
            ];
